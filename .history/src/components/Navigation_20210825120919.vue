	...
	<header id="home">
		<nav class="navigation">
			...
			<div class="navigation__links">
				<ul v-show="!mobile">
					<li>
						<router-link class="link" href="#home" v-smooth-scroll
							>Home</router-link
						>
					</li>
					<li>
						<router-link class="link" href="#projects" v-smooth-scroll
							>Projects</router-link
						>
					</li>
					<li>
						<router-link class="link" href="#about" v-smooth-scroll
							>About</router-link
						>
					</li>
					<li>
						<router-link class="link" href="#contact" v-smooth-scroll
							>Contact</router-link
						>
					</li>
				</ul>
