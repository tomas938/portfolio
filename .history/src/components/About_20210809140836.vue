	...
	<section class="about">
		...
		<div class="about__content">
			...
			<a
				class="js"
				target="_blank"
				href="https://www.udemy.com/course/the-complete-javascript-course/learn/lecture/22649535?start=900#overview"
				>Javascript</a
			>. Then I decided to take a course to learn css prepocessor
			<a class="sass" target="_blank" href="">Sass</a> and javascript framework
			<a class="vuejs" target="_blank" href="">Vue.js</a> and I also purchase
			course about 3D javascript library
			<a class="threejs" target="_blank" href="">Three.js</a>
